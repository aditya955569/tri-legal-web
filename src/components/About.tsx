      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <Button size="lg" className="bg-slate-700 hover:bg-slate-800 text-white px-8 shadow-md">
              Learn More About Us
            </Button>
          </div>
            ...
            <div className="bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl p-8 transform rotate-3">
              <div className="bg-white rounded-xl p-6 transform -rotate-3">
                ...
                <div className="mt-4 text-center">
                  <h3 className="font-bold text-slate-700 text-lg">Our Downtown Office</h3>
                  <p className="text-slate-600">Where excellence meets accessibility</p>
                </div>
              </div>
            </div>
          </div>
