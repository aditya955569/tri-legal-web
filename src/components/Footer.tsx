        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              ...
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Civil Litigation</li>
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Constitutional Law</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              ...
              <li className="hover:text-blue-400 cursor-pointer transition-colors">Case Results</li>
        ...
        <div className="border-t border-slate-600 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6 mt-4 md:mt-0">
              ...
              <span className="text-slate-400 text-sm hover:text-blue-400 cursor-pointer transition-colors">Legal Disclaimer</span>
            </div>
          </div>
        </div>
      </div>
