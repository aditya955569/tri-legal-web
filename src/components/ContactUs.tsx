      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {inputFields.map((field) => (
                      <div key={field.id} className={field.colSpan}>
                        ...
                        <Input
                          ...
                          aria-required={true}
                          className="border placeholder-white transition-all duration-200"
                          style={{
                            borderColor:
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="border placeholder-white min-h-32 transition-all duration-200"
                    />
                  </div>
            ...
            {/* Google Map */}
            <div className="w-full h-[300px] sm:h-[400px] lg:h-auto rounded-xl overflow-hidden shadow-lg border-2">
              <iframe
